...
test.describe("Verify login", () => {
  ...
  test("Verify user is able to login with valid credentials", { tag: ["@login", "@smoketest"] }, async ({ Given, ecomLoginPage, page, And, When, Then }) => {
...
const bddFileMeta = {
  "Verify user is able to login with valid credentials": {"pickleLocation":"8:3","tags":["@login","@smoketest"],"ownTags":["@smoketest"]},
  "Verify user is not able login with following credentails|Example #1": {"pickleLocation":"26:7","tags":["@login"]},
  "Verify user is not able login with following credentails|Example #2": {"pickleLocation":"27:7","tags":["@login"]},
  "Verify user is not able login with following credentails|Example #3": {"pickleLocation":"28:7","tags":["@login"]},
  "Verify user is not able login with following credentails|Example #4": {"pickleLocation":"29:7","tags":["@login"]},
  "Verify user is not able login with following credentails|Example #5": {"pickleLocation":"30:7","tags":["@login"]},
};